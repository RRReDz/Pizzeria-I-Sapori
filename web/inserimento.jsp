...
<form id="form_inserimento" method="post" action="./Controller">
  <fieldset>
    <input type="hidden" name="action" value="inserisci_pizza"/>
    <input type="hidden" name="tipo" value="inserisci" />
    <p>Nome: <input type="text" name="nome" required="required"><br></p>
      <div id="ingredienti">
        <p>Ingredienti:<br>
            <div class="ingredienti">
            <label><input name="ingredienti" type="checkbox" value="Pomodoro">Pomodoro</label><br>
